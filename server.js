...
const connection = mysql.createConnection({
  ...
  user: 'root',
  password: '013206',
  database: 'comprehensive_supermarket',
...
// 2.2
// create an account for customer. Every customer who buy something here must have an account first.
...
app.post('/updateShelf', (req, res) => {
    ...
    connection.beginTransaction(err => {
        ...
        // insert  one piece of product management record
        ...
        connection.query(insertRecordSql, [pk_management_record_id, responsible_employee_id, product_id, variant_id, warehouse_change_quantity, shelf_change_quantity], (err, results) => {
            ...
            connection.query(updateWarehouseSql, [warehouse_change_quantity, product_id, variant_id], (err, results) => {
                ...
                connection.query(updateShelfSql, [shelf_change_quantity, product_id, variant_id], (err, results) => {
                    ...
                    // if every on the right track, commit
                    connection.commit(err => {
                        if (err) {
                            connection.rollback(() => {
                                return res.status(500).send('Transaction commit failed: ' + err.message);
...
app.get('/showCustomers', (req, res) => {
    ...
    const query = `
    SELECT * FROM comprehensive_supermarket.t_customers;
    `;
    connection.query(query, (err, results) => {
        if (err) {
            return res.status(500).send('Failed to execute query: ' + err.message);
...
app.get('/showEmployees', (req, res) => {
    console.log('Request received');
    const query = `
    SELECT * FROM comprehensive_supermarket.t_employees;
    `;
    connection.query(query, (err, results) => {
        if (err) {
            return res.status(500).send('Failed to execute query: ' + err.message);
...
app.get('/showProductManagement', (req, res) => {
    console.log('Request received');
    const query = `
    SELECT * FROM comprehensive_supermarket.t_product_management_records;
    `;
    connection.query(query, (err, results) => {
        if (err) {
            return res.status(500).send('Failed to execute query: ' + err.message);
...
app.get('/showProductVariants', (req, res) => {
    console.log('Request received');
    const query = `
    SELECT * FROM comprehensive_supermarket.t_product_variants;
    `;
    connection.query(query, (err, results) => {
        if (err) {
            return res.status(500).send('Failed to execute query: ' + err.message);
...
app.get('/showProducts', (req, res) => {
    console.log('Request received');
    const query = `
    SELECT * FROM comprehensive_supermarket.t_products;
    `;
    connection.query(query, (err, results) => {
        if (err) {
            return res.status(500).send('Failed to execute query: ' + err.message);
...
app.get('/showReductionPromotions', (req, res) => {
    console.log('Request received');
    const query = `
    SELECT * FROM comprehensive_supermarket.t_reduction_promotions;
    `;
    connection.query(query, (err, results) => {
        if (err) {
            return res.status(500).send('Failed to execute query: ' + err.message);
...
app.get('/showSupplierContacts', (req, res) => {
    console.log('Request received');
    const query = `
    SELECT * FROM comprehensive_supermarket.t_supplier_contacts;
    `;
    connection.query(query, (err, results) => {
        if (err) {
            return res.status(500).send('Failed to execute query: ' + err.message);
...
app.get('/showSuppliers', (req, res) => {
    console.log('Request received');
    const query = `
    SELECT * FROM comprehensive_supermarket.t_suppliers;
    `;
    connection.query(query, (err, results) => {
        if (err) {
            return res.status(500).send('Failed to execute query: ' + err.message);
...
app.get('/showSupplyRecords', (req, res) => {
    console.log('Request received');
    const query = `
    SELECT * FROM comprehensive_supermarket.t_supply_records;
    `;
    connection.query(query, (err, results) => {
        if (err) {
            return res.status(500).send('Failed to execute query: ' + err.message);
...
app.get('/showTransDetails', (req, res) => {
    console.log('Request received');
    const query = `
    SELECT * FROM comprehensive_supermarket.t_transaction_details;
    `;
    connection.query(query, (err, results) => {
        if (err) {
            return res.status(500).send('Failed to execute query: ' + err.message);
...
app.get('/showTransRecords', (req, res) => {
    console.log('Request received');
    const query = `
    SELECT * FROM comprehensive_supermarket.t_transaction_records;
    `;
    connection.query(query, (err, results) => {
        if (err) {
            return res.status(500).send('Failed to execute query: ' + err.message);
...
app.get('/showVariantDiscounts', (req, res) => {
    console.log('Request received');
    const query = `
    SELECT * FROM comprehensive_supermarket.t_variant_discounts;
    `;
    connection.query(query, (err, results) => {
        if (err) {
            return res.status(500).send('Failed to execute query: ' + err.message);
